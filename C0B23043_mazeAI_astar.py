...
class Node:
    def __init__(self, position, parent=None, cost=0, fcost=0, heuristic=0):
    ...
    def dijkstra(visit_maze,data,move_cost):
        ...
        while queue:
            ...
            for i in range(1, len(queue)):
                if queue[i].fcost < queue[min_index].fcost:
                    min_index = i
            ...
            for move in moves:
                ...
                if next_pos[0] >= 0 and next_pos[0] < len(visit_maze) and next_pos[1] >= 0 and next_pos[1] < len(visit_maze[0]):
                    if visit_maze[next_pos[0]][next_pos[1]]=="0":
                        ...
                        current_node.heuristic = abs(next_pos[0]-current_node.position[0])+abs(next_pos[1]-current_node.position[1])
                        current_node.fcost=next_cos+current_node.heuristic
                        ...
                        for node in queue:
                            ...
                            if node.position == next_pos:
                                # print("#"*10)
                                if current_node.cost+next_cos<=node.fcost or node.fcost==0:
                                    # print("?"*10)
                                    node.fcost=current_node.fcost
                                ...
                                break
                        if not update:
                            next_node = Node(next_pos,current_node,current_node.cost+next_cos,current_node.fcost)
                            queue.append(next_node)
